...
public class WelcomeSliderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     /*   if (CommonMethods.getPrefrence(WelcomeSliderActivity.this, AllKeys.USER_ID).equals(AllKeys.DNF)) {
            launchHomeScreen();
            finish();
        }*/
    ...
    private void launchHomeScreen() {
        startActivity(new Intent(WelcomeSliderActivity.this, LoginActivity.class));
        finish();
    }
