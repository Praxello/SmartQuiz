...
import com.praxello.smartmcq.widget.facedistance.CameraSurfaceView;
import com.praxello.smartmcq.widget.facedistance.messages.MeasurementStepMessage;
import com.praxello.smartmcq.widget.facedistance.messages.MessageHUB;
import com.praxello.smartmcq.widget.facedistance.messages.MessageListener;

import java.text.DecimalFormat;
import java.util.List;

public class DemoFaceDistanceActivity extends AppCompatActivity implements MessageListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_demo_face_distance);
        ...
        _currentDistanceView.addTextChangedListener(new TextWatcher() {
    ...
    public void updateUI(final MeasurementStepMessage message) {
        ...
        distance = _decimalFormater.format(message.getDistToFace());
    ...
    public void onMessage(int messageID, Object message) {
        switch (messageID) {
            ...
            case MessageHUB.DONE_CALIBRATION:
                Toast.makeText(this, "away1", Toast.LENGTH_SHORT).show();
                _calibrateButton.setBackgroundResource(R.drawable.green_button);

                break;
            default:
                Toast.makeText(this, "away2", Toast.LENGTH_SHORT).show();
                break;
        }
    }
}
